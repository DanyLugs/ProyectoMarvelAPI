...
import com.danylugo.bottomnavigationproyecto.MainActivity;
...
public class SpiderSelector extends AppCompatActivity {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.card:
                Intent intent = new Intent(com.danylugo.bottomnavigationproyecto.SpiderSelector.this, MainActivity.class);
